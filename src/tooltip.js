...
(function (exports) {
    ...
    var buttonsAction = function buttonsAction() {
    ...
    var generateAnchorTag = function generateAnchorTag(anchorType, index) {
        var customIconClass = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
        ...
        if (customIconClass) {
            ...
            anchorIcon.classList.add('glyphicon' , 'glyphicon-' + anchorType);
        }
        ...
        anchorTag.addEventListener('click', function (e) {
            ...
            e.preventDefault();
            if (parameters.actions && parameters.actions[index]) {
    ...
    var generateTooltip = function generateTooltip() {
        ...
        Array.prototype.forEach.call(parameters.buttons, function (btn, index) {
            var aTag = generateAnchorTag(btn, index);
